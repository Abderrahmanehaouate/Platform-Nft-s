        ...
        <main class="main">
                    ...
                    <div class="home__group">
                        <div class="home__images">
                            <div class="home__img-eth">
                                <img src="images/ethereum-img.png" alt="home image">
                            </div>
                            <div class="home__img-orbe">
                                <img src="images/orbe-img.png" alt="home image">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- <section class="new-product">
                <div class="container">
                    <div class="section-header-wrapper">
                        ...
                        <a href="nfts.html" class="btn btn-primary">View all</a>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <section class="services">
                            <div class="heading">
                                <h2 style="text-align:center;">Create and sell your NFTs</h2>
                                
                            </div>

                        <div class="cards">

                            <!-- <a href="nfts.php" class="card">
                                <div class="light"></div>
                                <img src="images/Artist/artiste.png" alt="wallet">
                                <h3>Make Your Self Artist</h3>
                                <p>
                                    NFT's ate transforming the way 
                                    commerce is transacted
                                </p>
                            </a> -->


                            <a href="add_collection.php" class="card">
                                <div class="light"></div>
                                <img src="images/collectionImg/camera.png" alt="camera">
                            ...
                            <a href="add_nft.php" class="card">
                                <div class="light"></div>
                                <img src="images/collectionImg/gift.png" alt="gift">
                                <h3>Add your NFTs</h3>
                                <p>
                                    NFT's ate transforming the way 
                                    commerce is transacted
            ...
            <section class="collection">
                ...
                <div class="cards">
                    ...
                    $collections = $db->query('SELECT * FROM collection limit 4')->fetchAll(PDO::FETCH_ASSOC);

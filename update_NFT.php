        ...
        <div class="form-box">
            ...
            <?php
                ...
                if(isset($_POST['AddNft'])){
                    ...
                    if(empty($_POST['descN'])){
                        $descN = $categorie['descriptionN'];
                    }
                    if(empty($_POST['colN'])){
                        $colN = $categorie['idCol'];
                    }
                        
                    if(!empty($nameN) && !empty($descN) && !empty($priceN) && !empty($colN)){
            ...
            <form method="post" id="login" class="input-groupe" enctype="multipart/form-data">
                <h2 class="Admin-title">Admin Update NFT</h2>
                ...
                <br><br><br>
                <button type="submit" class="submit-btnn" name="AddNft">Update</button>
            </form>
        </div>
    </div>
    <!--=============== MAIN JS ===============-->
